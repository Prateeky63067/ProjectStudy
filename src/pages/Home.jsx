            ...
            <div>
                ...
                heading={
                    <div className='text-4xl font-semibold'>
                        ...
                        with or online courses
                    </div>
                }
                subheading={
                    "Our courses are designed and taught by industry experts whohave years of experience in coding and are passionate about sharing their knowledge with you"
                }
                ctabtn1={
                    {
             ...
             <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                    <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                          ...
                          <div className='flex flex-col w-[40%] gap-10 items-start'>
                                ...
                                The modern StudyNotion is dictates its own term, Today , to be a competive specalist requires more than professionals skills
                                </div>
